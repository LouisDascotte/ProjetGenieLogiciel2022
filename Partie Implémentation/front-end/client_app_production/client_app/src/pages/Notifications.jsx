...
const Notifications = () => {
  ...
  function notificationMessages(code){
    switch (code) {
      ...
      case "GREEN_CERTIFICATE_ACCEPTED_NOTIFICATION": 
        return t('GREEN_CERTIFICATE_ACCEPTED_NOTIFICATION');
      case "PRODUCTION_POINT_ACCEPTED_NOTIFICATION":
        return t('PRODUCTION_POINT_ACCEPTED_NOTIFICATION');
      default :
