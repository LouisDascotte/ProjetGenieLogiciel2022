  ...
  return (
    <Stack direction='row' sx={{width:"100%", height:"100%", position:'fixed'}}>
      ...
      <Stack sx={{display:'flex', width:"100%", height:'90%'}}>
        <TopMenu pageAddress={"/certificates"} pageName={"Green certificates"}/>
        <Stack justifyContent={'center'} alignContent="center" alignItems='center' sx={{height:"100%"}}>
          ...
          <Button variant='contained' sx={{width:"50%"}} onClick={()=>setOpen(true)}>
            Request Green Certificate
          </Button>
          <Dialog open={open} onClose={() => setOpen(false)}>
            <Stack justifyContent='center' alignItems='center' alignContent='center'>
              <DialogTitle>Request Green Certificate</DialogTitle>
              <DialogContent>
                <Typography>
                  Are you sure you want to request a green certificate for this portfolio ?
                </Typography>
              </DialogContent>
