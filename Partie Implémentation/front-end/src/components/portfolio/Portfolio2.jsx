import { Button, FormControl, Select, IconButton, Card, MenuItem, Stack,Dialog, DialogTitle, DialogContent, TextField, Typography, skeletonClasses, Box, Grid } from '@mui/material';
        ...
        <Stack alignItems='center' justifyContent={"center"}>
          <Card sx={{m:5}} container justify='center'>
            ...
            <Typography variant="h5" sx={{m:2}}>
              Actual supply points
            </Typography>
            {portfolio.supplyPoints.map(meter => 
            <Stack direction="row">
